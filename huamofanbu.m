...
%     u = 1/B*(-A*x2(k)+ddx1d(k)-c*de1+ds);             %控制规律
    u = 1.7213*x2(k)-0.7189*x1(k)+ddx1d(k)-b*(q/p)*(e1^(q/p-1))*de1+ds;
...
% subplot(212);
% figure
% plot( x2d, 'LineWidth', 2); hold on                  % 绘制目标曲线
